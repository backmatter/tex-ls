...
//! binding for meaning's LaTeX surface CST.
...
/// The rowan language marker for meaning's CST.
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub enum MeaningLang {}

impl_rowan_lang!(MeaningLang, SyntaxKind, "LaTeX");

pub type SyntaxNode = rowan::SyntaxNode<MeaningLang>;
pub type SyntaxToken = rowan::SyntaxToken<MeaningLang>;
pub type SyntaxElement = rowan::SyntaxElement<MeaningLang>;

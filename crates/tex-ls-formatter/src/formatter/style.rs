...
//! default. Native configuration and embedded hosts reuse these types through
//! `settings::FormatConfig`. Serialized names are public API and use kebab case.
...
/// `docs/development/architecture.md`, § *The formatter*).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
#[cfg_attr(
    feature = "serde",
    derive(serde::Serialize, serde::Deserialize),
...
mod serde_tests {
    ...
    /// These strings are `tex-ls.toml`'s, and embedders (a WASM embedder)

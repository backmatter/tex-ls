...
use meaning_parser::ast::{command_name, environment_name};
use meaning_parser::semantic::signature::{ArgKind, ArgSpec, match_arg_slot_index};
...
/// per slot, each chunk a [`ParameterInformationLabel::UIntPair`] range (counted in the

...
//!
//! [`scan_definition_sites`]: meaning_parser::semantic::scan_definition_sites
...
use meaning_analysis::project::{PackageGraph, ResolvedLabels};
use meaning_parser::ast::{environment_name, environment_name_range};
use meaning_parser::semantic::{DefSite, DefSiteKind};
...
mod tests {
    ...
    use meaning_parser::semantic::scan_definition_sites;

//! Shared diagnostic rendering for terminal clients and rule explanations: pretty (annotate-snippets), concise, and
...
/// ANSI escapes. The caller resolves it against the

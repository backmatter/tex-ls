...
impl Rule for DuplicateLabel {
    ...
    fn description(&self) -> &'static str {
        "Report repeated label keys within one document's namespace, including shared source \
         files. Definitions in mutually exclusive conditional branches are excluded. No fix is \
         offered because either renaming or deleting a definition may be appropriate."
    }

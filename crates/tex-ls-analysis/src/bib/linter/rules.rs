...
//!
//! Project facts support rules that need bibliography membership. String macro
//! resolution remains local to each file.
//!
...
pub use unused_entry::UnusedEntry;
...
///   rules driven by the semantic [`Model`].

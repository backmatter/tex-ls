...
//! Report-only — deleting a field is semantics-changing.
//!
...
impl BibRule for UnknownField {
    ...
    fn description(&self) -> &'static str {
        "Report fields not listed for a known entry type and without global field metadata. \
         BibLaTeX ignores unknown fields. Unknown entry types are excluded, and no fix is offered \
         because deleting a field would discard data."
    }

//! tex-ls-parser — the lossless CST parser, semantic model, and
//! command-signature database behind [tex-ls](https://github.com/backmatter/tex-ls), for
...
// Bound recursive grammar work and the trees consumed by shared features.
pub(crate) const MAX_PARSE_DEPTH: usize = 128;
pub(crate) const NESTING_LIMIT_ERROR: &str = "maximum parser nesting depth exceeded";

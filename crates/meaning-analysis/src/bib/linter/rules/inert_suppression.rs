...
const EXAMPLES: &[Example] = &[Example {
    ...
    source: "@comment{meaning-format skip-file: preserve this file}\n@book{key}\n",
}];
...
impl BibRule for InertSuppression {
    ...
    fn description(&self) -> &'static str {
        "Flag a structured BibTeX suppression directive that cannot take effect: \
         ...
         `meaning-format` directive, because the BibTeX formatter does not support \
...
mod tests {
    ...
    fn accepts_honored_lint_and_combined_directives() {
        for src in [
            "@comment{meaning-lint skip missing-required-field}\n@book{a}\n",
            "@comment{meaning-lint off missing-required-field}\n@book{a}\n@comment{meaning-lint on missing-required-field}\n",
            "@comment{meaning-lint skip-file missing-required-field}\n",
            "@comment{meaning skip}\n@book{a}\n",
        ] {

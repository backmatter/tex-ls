...
arity** — exactly the bulk tier meaning wants *underneath* its hand-curated
...
DATA_FILE = Path(__file__).resolve().parent.parent / "crates" / "meaning-parser" / "data" / "cwl_signatures.json"

...
class SummaryTests(unittest.TestCase):
    def test_server_summary_uses_medians_and_meaning_ratio(self):
        runs = [
        ...
        records = [
            {"key": "meaning", "summary": summary},
            {"key": "texlab", "summary": {**summary, "settled_rss_mb": 42}},
        ]
        memory.add_relative_memory(records)
        self.assertEqual(records[0]["summary"]["relative_to_meaning"], 1.0)
        self.assertEqual(records[1]["summary"]["relative_to_meaning"], 2.0)

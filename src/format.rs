//! CLI/LSP bridge over the [`meaning_formatter`] engine.
//!
//! The formatting engine lives in the `meaning-formatter` crate; this module
...
pub use meaning_formatter::formatter::*;

//! Growth-rate guards for previously quadratic parsing and diagnostic-rendering paths.
//!
...
use tex_ls_analysis::linter::{Diagnostic, Severity};
use tex_ls_formatter::formatter::{FormatStyle, format_node};

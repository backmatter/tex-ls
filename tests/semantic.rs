...
use meaning_analysis::incremental::{IncrementalDatabase, QueryKind, SourceId};
use meaning_parser::semantic::{RefCommand, SemanticModel};
...
fn snapshot(db: &IncrementalDatabase, file: SourceId) -> Snapshot {

// The docs playground: two CodeMirror editors over the meaning-wasm formatter,
...
import initWasm, { check, format } from "./pkg/meaning_wasm.js";
...
Meaning is a formatter, linter, and language server for LaTeX. It reflows prose to the configured line width, normalizes spacing in math, and never touches verbatim regions.
...
async function main() {
  ...
  els.theme.addEventListener("click", () => {
    ...
    localStorage.setItem("meaning-playground-theme", dark ? "dark" : "light");
  });
